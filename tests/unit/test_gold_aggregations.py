...
def silver_master(spark):
    ...
    return (
        df.withColumn("order_purchase_timestamp", to_timestamp("order_purchase_timestamp"))
        .withColumn("order_delivered_customer_date", to_timestamp("order_delivered_customer_date"))
        .withColumn("_silver_processed_at", to_timestamp("_silver_processed_at"))
    )
